...
for (int t = 0; ((1) >= 0 ? t <= BALL_TILES : t >= BALL_TILES); t += (1)) { // L0154
...
// __VB_LINE__:165 // L0199
} // L0200
// __VB_LINE__:166 // L0201
} // L0202
// __VB_LINE__:167 // L0203
} // L0204
// __VB_LINE__:168 // L0205
} // L0206
// __VB_LINE__:171 // L0207
float shadowScale = 0; // L0208
// __VB_LINE__:172 // L0209
float shadowNorm = 0; // L0210
// __VB_LINE__:173 // L0211
shadowNorm = 1 - ((ballY - (centerY - amplitude)) / (2 * amplitude)); // L0212
// __VB_LINE__:174 // L0213
shadowScale = 0.6 + 0.9 * shadowNorm; // L0214
// __VB_LINE__:175 // L0215
if (shadowScale < 0.5) { shadowScale = 0.5; } // L0216
// __VB_LINE__:176 // L0217
if (shadowScale > 1.6) { shadowScale = 1.6; } // L0218
// __VB_LINE__:179 // L0219
shadow.fillSprite(COLOR_BG); // L0220
// __VB_LINE__:181 // L0221
...
// L0351
void loop() { // L0352
    // __VB_LINE__:209 // L0353
    bg.pushSprite(0, 0); // L0354
    // __VB_LINE__:211 // L0355
    if (isMovingRight) { // L0356
    // __VB_LINE__:212 // L0357
    ballX = ballX + ballVX; // L0358
    // __VB_LINE__:213 // L0359
    phase = phase + PHASE_STEP; // L0360
    // __VB_LINE__:214 // L0361
    if (ballX >= rightBound) { // L0362
    // __VB_LINE__:215 // L0363
    isMovingRight = false; // L0364
    // __VB_LINE__:216 // L0365
    } // L0366
    // __VB_LINE__:217 // L0367
    } else { // L0368
    // __VB_LINE__:218 // L0369
    ballX = ballX - ballVX; // L0370
    // __VB_LINE__:219 // L0371
    phase = phase - PHASE_STEP; // L0372
    // __VB_LINE__:220 // L0373
    if (ballX <= leftBound) { // L0374
    // __VB_LINE__:221 // L0375
    isMovingRight = true; // L0376
    // __VB_LINE__:222 // L0377
    } // L0378
    // __VB_LINE__:223 // L0379
    } // L0380
    // __VB_LINE__:226 // L0381
    ballY = ballY + ballVY; // L0382
    // __VB_LINE__:227 // L0383
    ballVY = ballVY + 0.6; // L0384
    // __VB_LINE__:228 // L0385
    if (ballY >= centerY + amplitude) { // L0386
    // __VB_LINE__:229 // L0387
    ballY = centerY + amplitude; // L0388
    // __VB_LINE__:230 // L0389
    ballVY = -abs(ballVY) * 0.92; // L0390
    // __VB_LINE__:231 // L0391
    isMovingUp = false; // L0392
    // __VB_LINE__:232 // L0393
    } else if (ballY <= centerY - amplitude) { // L0394
    // __VB_LINE__:233 // L0395
    ballY = centerY - amplitude; // L0396
    // __VB_LINE__:234 // L0397
    ballVY = abs(ballVY) * 0.92; // L0398
    // __VB_LINE__:235 // L0399
    isMovingUp = true; // L0400
    // __VB_LINE__:236 // L0401
    } else { // L0402
    // __VB_LINE__:238 // L0403
    isMovingUp = (ballVY < 0); // L0404
    // __VB_LINE__:239 // L0405
    } // L0406
    // __VB_LINE__:241 // L0407
    DrawBall(); // L0408
    // __VB_LINE__:244 // L0409
    prevBallX = ballX; // L0410
    // __VB_LINE__:245 // L0411
    prevBallY = ballY; // L0412
    // __VB_LINE__:248 // L0413
    delay(20); // L0414
} // L0415
